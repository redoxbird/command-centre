...
// Regenerate: deno task build:grammar. Source hash: dd790c7b9a4593dc710d0ae10d1d3dc26467b275d4d463f8dc3dab8e65ceafc3
var CCGrammarSrc = (() => {
  ...
  function rangeSpec(params) {
    const noDefault = String(params != null ? params : "").split("=")[0];
    const parts = String(params != null ? params : "").split(":");
...
window.CCGrammar = Object.assign({ GRAMMAR_HASH: "dd790c7b9a4593dc710d0ae10d1d3dc26467b275d4d463f8dc3dab8e65ceafc3" }, window.CCGrammarSrc);
